...
?>
	...
	?>
	<!-- begin-main-content -->
    <section class="<?php echo ( 'both' == $webnus_options->webnus_blog_sidebar() )? 'col-md-4 alpha omega':( ('none' != $webnus_options->webnus_blog_sidebar() )?'col-md-8 blogz': 'col-md-12 omega') ?>">
     <?php
