...
<section id="main-content" class="wpb_row vc_row-fluid full-row">
		...
		<div class="contact-form">
			...
			<form action="<?php the_permalink(); ?>" method="POST" id="contact-form" class="frmContact" role="form" novalidate>
				<div class="field-group">
					<h5><?php esc_html_e( 'Company', 'WEBNUS_TEXT_DOMAIN' ); ?></h5>
					<input type="text" name="cName" class="txbx" placeholder="" value="<?php if ( isset( $_POST['cName'] ) ) { echo esc_html( $_POST['cName'] ); } ?>" /><br>
				...
				<div class="field-group">
					<h5><?php esc_html_e( 'Email','WEBNUS_TEXT_DOMAIN' ); ?></h5>
					<input  type="text" name="cEmail" class="txbx" placeholder="" value="<?php if ( isset( $_POST['cEmail'] ) ) { echo esc_html( $_POST['cEmail'] ); } ?>" /><br>
				...
				<div class="field-group">
					<h5><?php esc_html_e( 'Phone','WEBNUS_TEXT_DOMAIN' ); ?></h5>
					<input name="cSubject" type="text" class="txbx" placeholder="" value="<?php if ( isset( $_POST['cSubject'] ) ) { echo esc_html( $_POST['cSubject'] ); } ?>" /><br>
				</div>

				<div class="erabox">
					<div class="field-group">
						<h5><?php esc_html_e( 'Message','WEBNUS_TEXT_DOMAIN' ); ?></h5>
	...
	<div class="white-space" style="height:40px;"></div>
	</section>
	<section class="">
		<div id="contact-map">
			<!-- <?php echo $webnus_options->webnus_google_map(); ?> -->
			<?php putRevSlider( "mapascontacto" ) ?>
			<!-- http://staticmapmaker.com/bing/ -->
		</div><!-- END-contact Map -->
	...
	<section class="container">
		<div class="col-sm-4">
			...
			<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/mapa.png" class="img-block" alt="" />
		</div>
		<div class="col-sm-8">
			<h5>EMEA / LATAM / NA</h5>
			<p>Maecenas faucibus mollis interdum. Praesent commodo cursus magna, vel scelerisque nisl consectetur et. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus. Nullam quis risus eget urna mollis ornare vel eu leo.</p>
		</div>
	</section>
	<hr class="vertical-space3">
