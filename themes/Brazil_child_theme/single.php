...
get_header();
 ...
 <section class="container page-content" >
    ...
    <a href="<?php echo site_url(); ?>/noticias-innova" class="button orange medium bordered-bot sm19 align-right"><?php _e('Back to news','WEBNUS_TEXT_DOMAIN'); ?></a>
    <?php 
	...
	<section class="<?php echo ( 'none' == $webnus_options->webnus_blog_singlepost_sidebar()  )?'col-md-12':'col-md-8'?> omega ">
      ...
      // comments_template(); ?>
			<?php
				// AÑADIR AQUÍ ARTÍCULOS RELACIONADOS
			?>
    </section>
    <!-- end-main-conten -->
    <?php
