<?php
 ...
 function webnus_latestfromblog( $attributes, $content = null ) {
	...
	if (is_page( 225 )) {
		$wpbp = new WP_Query(array( 'category_name' => 'Innova', 'post_type' => 'post', 'posts_per_page' => 4));
	}	
	elseif (is_front_page()) {
		$wpbp = new WP_Query(array( 'category_name' => 'News','post_type' => 'post', 'posts_per_page' => 4));
	}	
	else {
